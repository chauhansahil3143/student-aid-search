        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-6 sm:flex-row">
            <Link to="/report?type=lost">
              <Button
                size="lg"
                className="min-w-[200px] border-2 border-primary bg-accent text-foreground hover:bg-accent/90 hover:text-foreground font-bold uppercase tracking-wide shadow-button brutalist-hover font-body"
              >
